...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.taux_mutation_entry = QtWidgets.QLineEdit(self.frame)
        self.taux_mutation_entry.setGeometry(QtCore.QRect(230, 460, 181, 31))
        self.taux_mutation_entry.setObjectName("lineEdit")
        self.taux_mutation_label = QtWidgets.QLabel(self.frame)
        self.taux_mutation_label.setGeometry(QtCore.QRect(50, 460, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        self.taux_mutation_label.setFont(font)
        self.taux_mutation_label.setStyleSheet("color:#888")
        self.taux_mutation_label.setObjectName("taux_mutation_label")
    ...
    def init_geo(self):
        ...
        if self.is_number(self.taux_mutation_entry.text()):
            self.mutation_rate = float(self.taux_mutation_entry.text())
        else:
            self.mutation_rate = 0.3
            self.taux_mutation_entry.setText("0.3")
            self.taux_mutation_entry.update()
